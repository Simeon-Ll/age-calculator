...
function App() {
  ...
  return (
    <div className='relative w-11/12 bg-White flex flex-col items-center rounded-5xl rounded-br-7xl p-6 py-4 sm:w-128'>
      ...
      <div className='flex gap-5 py-5 pb-12 sm:pb-7 border-b-2 w-full justify-center  sm:justify-start '>
        ...
        <div>
          ...
          <div className='text-xs text-Light-red text-center h-8'>
          {error.dayError.state && 
            <p>{error.dayError.error}</p>
          }
          </div>
        </div>
        ...
        <div>
          ...
          <div className='text-xs text-Light-red text-center'>
      ...
      <div className=' absolute top-36 sm:top-32 w-10/12 flex justify-center sm:justify-end' >
